...
const Filter = () => {
  ...
  return (
    <Layout title={"ALl Products - Best offers "}>
      ...
      {/* Categories */}
      <h1 className="text-center mt-5 pt-5">Top Trending Collections</h1>
      <Categories />
      {/* Categories */}
      ...
      <div className="Trending_fashion_outfit">
        ...
        <NavLink className="btn btn-primary" to="/shop">Shop Now</NavLink>
      </div>
      {/* fashion outfit*/}
      <div className="container row mt-3 mx-md-auto home-page">
        <div className="col-md-3 filters">
          ...
          <div className="d-flex flex-column">
            <button
              className="btn btn-danger Reset_Filters"
